...
export interface $ZodObjectInternals<Shape extends $ZodShape = $ZodShape>
...
export interface $ZodObject<Shape extends $ZodShape = $ZodShape>
  extends $ZodType<$InferObjectOutput<Shape>, $InferObjectInput<Shape>, $ZodObjectInternals<Shape>> {
