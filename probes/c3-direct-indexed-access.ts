...
export type output<T extends { _zod: { output: unknown } }> = T["_zod"]["output"];
export type input<T extends { _zod: { input: unknown } }> = T["_zod"]["input"];
...
// ---- array ----
export interface $ZodArrayInternals<T extends { _zod: { output: unknown; input: unknown } } = $ZodType> extends $ZodTypeInternals<output<T>[], input<T>[]> {
...
// ---- optional ----
export interface $ZodOptionalInternals<T extends { _zod: { output: unknown; input: unknown } } = $ZodType>
...
// ---- nullable ----
export interface $ZodNullableInternals<T extends { _zod: { output: unknown; input: unknown } } = $ZodType>
...
declare function object<T extends $ZodLooseShape>(shape: T): $ZodObject<T>;
